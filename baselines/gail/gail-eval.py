...
def evaluate_env(env_name, seed, policy_hidden_size, stochastic, reuse, prefix):
    ...
    data_path = os.path.join('/home/shaoqian/CMDP/baselines/data', 'deterministic.trpo.' + env_name + '.0.00.npz')
    dataset = load_dataset(data_path)
    checkpoint_list = glob.glob(os.path.join('/home/shaoqian/CMDP/baselines/checkpoint', '*' + env_name + ".*"))
    log = {
        'traj_limitation': [],
        'upper_bound': [],
        'avg_ret': [],
